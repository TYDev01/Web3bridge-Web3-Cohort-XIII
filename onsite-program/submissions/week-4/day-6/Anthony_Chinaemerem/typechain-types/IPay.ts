...
export interface IPayInterface extends Interface {
  getFunction(nameOrSignature: "paySalary"): FunctionFragment;
...
export interface IPay extends BaseContract {
  connect(runner?: ContractRunner | null): IPay;
  ...
  paySalary: TypedContractMethod<[_to: AddressLike], [void], "payable">;
